...
wget https://github.com/bwagner5/vpcctl/releases/download/v0.0.3/vpcctl_0.0.3_${OS}_${ARCH}.deb
...
[[ `uname -m` == "aarch64" ]] && ARCH="arm64" || ARCH="amd64"
OS=`uname | tr '[:upper:]' '[:lower:]'`
rpm -i https://github.com/bwagner5/vpcctl/releases/download/v0.0.3/vpcctl_0.0.3_${OS}_${ARCH}.rpm
```
...
[[ `uname -m` == "aarch64" ]] && ARCH="arm64" || ARCH="amd64"
OS=`uname | tr '[:upper:]' '[:lower:]'`
wget -qO- https://github.com/bwagner5/vpcctl/releases/download/v0.0.3/vpcctl_0.0.3_${OS}_${ARCH}.tar.gz | tar xvz
chmod +x vpcctl
```
